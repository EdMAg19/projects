 ...
 */
    ...
    function menuInit() {
        let botHeadCont = document.querySelector(".bottom-header__container");
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                bodyLockToggle();
                document.documentElement.classList.toggle("menu-open");
                botHeadCont.classList.toggle("menu-open");
            }
        }));
    }
    function showMore() {
                ...
                if (targetType === "click") {
                    if (targetEvent.closest("[data-showmore-button]")) {
                        ...
                        if (!showMoreContent.classList.contains("_slide")) {
                            ...
                            showMoreContent.classList.toggle("hide-gradient");
                            const span = showMoreButton.querySelector("span");
                            if (span) span.classList.toggle("show-more-span");
                        }
                    }
    ...
    function initSliders(selector, options) {
        ...
        if (document.querySelector(".swiper-sales")) new Swiper(".swiper-sales", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            ...
            lazy: true,
            pagination: {
                el: ".swiper-sales-pagination",
                clickable: true,
                bulletClass: "swiper-sales-bullet",
                bulletActiveClass: "swiper-sales-active-bullet"
            },
            navigation: {
                prevEl: ".swiper-sales-button-prev",
                nextEl: ".swiper-sales-button-next"
            },
            breakpoints: {
                470: {
                    slidesPerView: 1.5,
        ...
        if (document.querySelector(".swiper-articles-reviews")) new Swiper(".swiper-articles-reviews", {
        ...
        if (document.querySelector(".swiper-articles-news")) new Swiper(".swiper-articles-news", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            spaceBetween: 20,
            ...
            lazy: true,
            navigation: {
                prevEl: ".swiper-articles-news-button-prev",
                nextEl: ".swiper-articles-news-button-next"
            },
            breakpoints: {
                400: {
                    slidesPerView: 1.5,
    ...
    spollers();
    showMore();
    const callButton = document.querySelector(".call__arrow");
    const callListClass = document.querySelector(".call__list");
    const downBtn = document.querySelector(".call__open-numbers");
    const closeBtn = document.querySelector(".call__close-numbers");
    callButton.addEventListener("click", (function() {
        callButton.classList.toggle("active");
        callListClass.classList.toggle("show");
        downBtn.classList.toggle("hidden");
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        searchBtn.addEventListener("click", (function() {
            ...
            if (mediaQuery.matches) inputSearchBtn.classList.toggle("active");
            if (searchInput.classList.contains("active")) searchInput.focus();
        }));
        document.addEventListener("click", (function(event) {
            if (!searchInput.contains(event.target) && !searchBtn.contains(event.target) && !inputSearchBtn.contains(event.target)) {
                searchInput.classList.remove("active");
                if (mediaQuery.matches) inputSearchBtn.classList.remove("active");
            }
        }));
    }));
})();